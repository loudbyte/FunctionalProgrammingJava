...
public class Chapter3Challenge1 {
    ...
    public static void main(String[] args) {
        ...
        List<String> personNames = people.stream().map(p -> p.name).collect(Collectors.toList());
        ...
        List<Car> blueCars = cars.stream().filter(car -> car.color.equals("blue"))
        ...
        Optional<Float> salarySum = employees.stream().map(employee -> employee.salary)
            .reduce(Float::sum);
